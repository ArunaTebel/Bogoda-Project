 ...
 * @author Pramo
 */
public class Report_PRCR_ETF_Monthly extends javax.swing.JPanel {
...
//                }
                ...
                String dateNow = generate.create("PRCR_Checkroll_Monthly_ETF_", "D:\\", param, location, "PRCR_Checkroll_Monthly_ETF.jrxml");
                a.stop();
                jProgressBar1.setValue(100);
                try {
                    generate.savename(dateNow, "PRCR_Checkroll_Monthly_ETF_", yearfield.getText() + datehandler.return_month_as_num(monthfield.getText()));
                } catch (SQLException ex) {
                    Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
                }
            } else {
...
//                }
                ...
                String dateNow = generate.create("PRCR_Checkroll_Monthly_ETF_ALL", "D:\\", param, location, "PRCR_Checkroll_Monthly_ETF_all.jrxml");
                a.stop();
                jProgressBar1.setValue(100);
                try {
                    generate.savename(dateNow, "PRCR_Checkroll_Monthly_ETF_ALL_", yearfield.getText() + datehandler.return_month_as_num(monthfield.getText()));
                } catch (SQLException ex) {
                    Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
                }
     ...
     *
     */
    public Report_PRCR_ETF_Monthly() {
        initComponents();
