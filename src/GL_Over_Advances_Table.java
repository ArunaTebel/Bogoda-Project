...
public class GL_Over_Advances_Table extends javax.swing.JPanel {
   // GL_other_advances_class oadvance = new GL_other_advances_class();
    ...
    public void set_table(int bottom, int top) {
        ...
        dbm.Inserting_To_The_Table(table, "gl_over_advance", "sup_id", 0, bottom, top);
        dbm.Inserting_To_The_Table(table, "gl_over_advance", "sup_name", 1, bottom, top);
        dbm.Inserting_To_The_Table(table, "gl_over_advance", "issued_date", 2, bottom, top);
        dbm.Inserting_To_The_Table(table, "gl_over_advance", "category_code", 3, bottom, top);
        dbm.Inserting_To_The_Table(table, "gl_over_advance", "advance_taken", 4, bottom, top);
 System.out.println("sheeeeeeeeeeet");
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Supp:ID", "Sup Name", "Date", "Category", "Advance Taken", "Max:allow"
            }
        ));
        ...
        if (!supplier_id.getSelectedItem().toString().equals("All")) {
            if (i > 0) {
                ...
                if (m >= 0) {
                    ...
                    // set_table(i + 1, i + 50);
                    filter.Filtered_table(table, "gl_over_advance", supplier_id.getSelectedItem().toString(), i + 1, i + 50);
    ...
    private void supplier_idItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_supplier_idItemStateChanged
        if (supplier_id.getSelectedItem().toString().equals( "All")) {
         ...
         if (!supplier_id.getSelectedItem().equals( "All")) {
            ...
            table_handler.clear_table(table, 10, 50);
            a_2 = filter.Filtered_table(table, "gl_over_advance", supplier_id.getSelectedItem().toString(), 1, 50);
            if (a % 50 == 0) {
                no_of_pages = a_2 / 50;
