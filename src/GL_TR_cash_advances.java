 ...
 * @author Pramo
 */
public class GL_TR_cash_advances extends javax.swing.JPanel {
    ...
    private void supplier_idItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_supplier_idItemStateChanged
        ...
        if (supplier_id.getSelectedIndex() != 0) {
            if (supplier_id.getSelectedItem() != null) {
                ...
                String result;
                try {
                    result = dbm.filterReturn2StringData("gl_tr_cash_advance", "sup_id", supplier_id.getSelectedItem() + "", "ordered_date", datechooser.Return_date(yearfield, monthfield, dayfield) + "", "entry_no");
...
//        update.update_month_check(Save, yearfield, monthfield);
    ...
    private void edit2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edit2KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                ...
                supplier_id.setSelectedItem(dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "sup_id"));

                String date = dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "issued_date");
                String pay = dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "pay_type");
                if (pay.equals("cash")) {
                ...
                String amo = dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "amount");
                amount.setText(amo);
                String sp = dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "special_permission");
                String em = dbm.checknReturnData("gl_tr_cash_advance", "entry_no", tr_no, "emergency");
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if (reply == JOptionPane.YES_OPTION) {
            ...
            dbm.CheckNDeleteFromDataBase("gl_tr_cash_advance", "entry_no", Integer.parseInt(edit2.getText()));
