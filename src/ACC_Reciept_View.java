...
public class ACC_Reciept_View extends javax.swing.JPanel {
    ...
    public void Set_Combo() {
        ...
        if (field_choice.getSelectedIndex() != 0) {
            int i = 0;
            int j = field_choice.getSelectedIndex()-1;
            for (i = 0; i < j; i++) {
                arr2[i] = arr[i];
            }
            for (i = j + 1; i < 11; i++) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (search.getText() == "All") {
            ...
            } else if (search.getText() == "Credit Account ID" || search.getText() == "Credit Description" || search.getText() == "Credit Amount" || (search.getText()=="Transaction No." && erChk.isSelected())) {
