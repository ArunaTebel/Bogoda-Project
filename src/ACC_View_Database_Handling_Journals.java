...
public class ACC_View_Database_Handling_Journals {
    ...
    public boolean Inserting_To_The_Table_Filtered_Journal_Full(javax.swing.JTable table, String column_name, int table_column_num, int bottom, int top, int key) {
        ...
        if (current.equals(given_period)) {
            ...
            try {
                ResultSet query = dbm.query("SELECT * FROM account_journal_main_all ");
                while (query.next()) {
                    ResultSet query1 = dbm.query("SELECT * FROM account_journal_creditside_all where tr_no = '" + query.getInt("tr_no") + "'");
                    while (query1.next()) {
                        rows_in_credit++;
                    }
                    query1.close();
                ...
                if (num_of_rows_in_the_database >= bottom) {
                    try {
                        ...
                        while (query.next()) {
                            ...
                            ResultSet query3 = dbm.query("SELECT * FROM account_journal_debitside_all where tr_no = '" + query.getInt("tr_no") + "'");
                            while (query3.next()) {
                ...
                if (num_of_rows_in_the_database >= bottom) {
                    try {
                        ...
                        while (query.next()) {
                            ...
                            ResultSet query3 = dbm.query("SELECT * FROM account_journal_creditside_all where tr_no = '" + query.getInt("tr_no") + "'");
                            while (query3.next()) {
                                if (count < bottom) {
    ...
    public boolean Inserting_To_The_Table_Filtered_Journal_Main_Search(javax.swing.JTable table, String column_name, int table_column_num, int bottom, int top, String column_filtering, Object element, int key) {
        ...
        if (current.equals(given_period)) {
            ...
            try {
                ResultSet query = dbm.query("SELECT * FROM account_journal_main_all where " + column_filtering + " LIKE '" + element + "'");
                while (query.next()) {
                    ResultSet query1 = dbm.query("SELECT * FROM account_journal_debitside_all where tr_no = '" + query.getInt("tr_no") + "'");
                    while (query1.next()) {
                        rows_in_debit++;
    ...
    public boolean Inserting_To_The_Table_Filtered_Journal_Debit_Search(javax.swing.JTable table, String column_name, int table_column_num, int bottom, int top, String column_filtering, Object element, int key) {
        ...
        if (current.equals(given_period)) {
            ...
            try {
                ResultSet query = dbm.query("SELECT * FROM account_journal_debitside_all where " + column_filtering + " LIKE '" + element + "'");

                while (query.next()) {
                    if (query.getInt("tr_no") != tr_no) {
                        ResultSet query1 = dbm.query("SELECT * FROM account_journal_debitside_all where tr_no LIKE '" + query.getInt("tr_no") + "'");
                        while (query1.next()) {
                            rows_in_debit++;
                        }
                        query1.close();
                        ResultSet query2 = dbm.query("SELECT * FROM account_journal_creditside_all where tr_no LIKE '" + query.getInt("tr_no") + "'");
                        while (query2.next()) {
                            rows_in_credit++;
                        }
                        query2.close();
                    ...
                    try {
                        ...
                        while (query.next()) {
                            if (tr_no != query.getInt("tr_no")) {
                                ...
                                ResultSet query2 = dbm.query("SELECT * FROM account_journal_debitside_all where tr_no = '" + query.getInt("tr_no") + "'");
                                while (query2.next()) {
                                    numd++;
                                    countd++;
                                }
                                ...
                                count = Math.max(countc, countd) + count;
                                num = Math.max(numc, numd);
                                ResultSet query1 = dbm.query("SELECT * FROM account_journal_main_all where tr_no = '" + query.getInt("tr_no") + "'");
                                while (query1.next()) {
                                    if (count < bottom) {
    ...
    public boolean Inserting_To_The_Table_Filtered_Journal_Credit_Search(javax.swing.JTable table, String column_name, int table_column_num, int bottom, int top, String column_filtering, Object element, int key) {
        ...
        if (current.equals(given_period)) {
            ...
            try {
                ResultSet query = dbm.query("SELECT * FROM account_journal_creditside_all where " + column_filtering + " LIKE '" + element + "'");
    ...
    public boolean Inserting_To_The_Table_Filtered_Journal_Date_Search(javax.swing.JTable table, String column_name, int table_column_num, int bottom, int top, String column_filtering, Object element1, Object element2, int key) {
        ...
        if (current.equals(given_period)) {
            ...
            try {
                ResultSet query = dbm.query("SELECT * FROM account_journal_main_all where " + column_filtering + " BETWEEN '" + element1 + "' AND '" + element2 + "'");
                while (query.next()) {
                    ResultSet query1 = dbm.query("SELECT * FROM account_journal_debitside_all where tr_no = '" + query.getInt("tr_no") + "'");
                    while (query1.next()) {
                        rows_in_debit++;
