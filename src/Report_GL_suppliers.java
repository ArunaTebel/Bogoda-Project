        ...
        public void run(){
           //  jProgressBar1.setIndeterminate(true);
                ...
                Thread a = new Thread(new Background());
                    ...
                    a.start();
                    generate.create("GL_SUPP", saveloc, param, location, "SupplierAll_cat.jrxml");
                    a.stop();
                    ;
                    ...
                    String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");
                    a.start();
                    generate.create("GL_SUPP", saveloc, param, location, "SupplierAll_welfare.jrxml");
                    a.stop();
                    ;
                    jProgressBar1.setValue(100);
            ...
            HashMap param = new HashMap();
                 //   param.put("route", Cat_code.getSelectedItem().toString());
                    ...
                    String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");
                    a.start();
                    generate.create("GL_SUPP", saveloc, param, location, "SupplierAll_Active.jrxml");
                    a.stop();
                    ;
                    jProgressBar1.setValue(100);
        }
         if(!active.isSelected()&& !welfare.isSelected()&& !route.isSelected()){
            ...
            HashMap param = new HashMap();
                    ...
                    String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");
                    a.start();
                    generate.create("GL_SUPP", saveloc, param, location, "SupplierAll.jrxml");
                    a.stop();
                    ;
                    jProgressBar1.setValue(100);
        }
