...
public class Payments_accounts {
    ...
    public boolean addToCreditDataBaseBank() {
        ...
        try {
            dbCon.insert("INSERT INTO account_payment_creditside(ref_no,payment_no,date,pay_type,credit_account_id,credit_account_name,credit_description,bank_id,bank_name,branch_id,branch_name,cheque_no,cheque_date,credit_amount) VALUES('" + refNo + "','" + paymentNo + "','" +date+"','" +payType+"','" +credit_accountCode+"','" +credit_accountName+"','" +credit_description+"','" +bankCode+"','" +bankName+"','" +branchCode+"','" +branchName+"','" +chequeNo+"','" +chequeDate+"','" +creditAmount+"')");
     ...
     public boolean addToCreditDataBaseCash() {
        DatabaseManager dbCon = DatabaseManager.getDbCon();
        try {
           dbCon.insert("INSERT INTO account_payment_creditside(ref_no,payment_no,date,pay_type,credit_account_id,credit_account_name,credit_description,credit_amount) VALUES('" + refNo + "','" + paymentNo + "','" +date+"','" +payType+"','" +credit_accountCode+"','" +credit_accountName+"','" +credit_description+"','" + creditAmount+"')");
