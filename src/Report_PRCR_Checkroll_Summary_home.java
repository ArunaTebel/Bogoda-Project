 ...
 * @author Pramo
 */
public class Report_PRCR_Checkroll_Summary_home extends javax.swing.JPanel {
...
//         param.put("Month", datehandler.return_month_as_num(monthfield.getText()));
           ...
           String dateNow= generate.create("Checkroll_Summary_", "D:\\", param, location, "PRCR_Checkroll_Summary.jrxml");
            a.stop();
            jProgressBar1.setValue(100);
            try {
                generate.savename(dateNow, "Checkroll_Summary_", yearfield.getText()+datehandler.return_month_as_num(monthfield.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
            }
     ...
     *
     */
    public Report_PRCR_Checkroll_Summary_home() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Checkroll Summary");
