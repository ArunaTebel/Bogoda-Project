 ...
 * @author Pramo
 */
public class Report_PRCR_EPF_backup extends javax.swing.JPanel {
...
//         param.put("Month", datehandler.return_month_as_num(monthfield.getText()));
        ...
        if (datehandler.return_index(monthfield.getText()) < 10) {
            ...
            dateNow = generate.create("PRCR_Checkroll_EPF_backup_", "D:\\", param, location, "PRCR_epf_etf_backup.jrxml");
            ...
            jProgressBar1.setValue(100);
            try {
                generate.savename(dateNow, "PRCR_Checkroll_EPF_backup_", yearfield.getText() + datehandler.return_month_as_num(monthfield.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("EPF-ETF Backup");
