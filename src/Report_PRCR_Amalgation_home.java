 ...
 * @author Pramo
 */
public class Report_PRCR_Amalgation_home extends javax.swing.JPanel {
...
//            param.put("Month", datehandler.Return_month_full(datehandler.return_index(monthfield.getText())) + " " + yearfield.getText().toString());
           ...
           String dateNow= generate.create("Checkroll_Amalgamation_", "D:\\", param, location, "PRCR_Checkroll_Amalgamation.jrxml");
            a.stop();
            jProgressBar1.setValue(100);
            try {
                generate.savename(dateNow, "Checkroll_Amalgamation_", yearfield.getText()+datehandler.return_month_as_num(monthfield.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
            }
     ...
     *
     */
    public Report_PRCR_Amalgation_home() {
        initComponents();
    ...
    private void view1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view1ActionPerformed
        ...
        rep.CreateReport(division_jc.getSelectedItem().toString(), getST(monthfield.getText(), yearfield.getText()));
