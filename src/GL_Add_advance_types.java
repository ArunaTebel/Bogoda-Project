...
Code.requestFocus();;
    ...
    private void initComponents() {
        ...
        Code.setModel(new javax.swing.DefaultComboBoxModel(dbm.getStringArray("gl_advance_types", "type")));
    ...
    private void account_nameKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_account_nameKeyPressed
        interface_events.Change_focus_Enterkey_t_b(account_name, Save, evt);
    ...
    private void CodeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_CodeItemStateChanged
        ...
        if (Code.getSelectedItem() != null) {
            account_name.setText(dbm.checknReturnStringData("gl_advance_types", "type", Code.getSelectedItem().toString(), "installments")+"");
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        try {
            dbCon.insert("INSERT INTO gl_advance_types(type,installments) VALUES('" + Code.getSelectedItem().toString() + "','" + account_name.getText()  + "')");
    ...
    private void Save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Save1ActionPerformed
        dbm.updateDatabase("gl_advance_types", "type", Code.getSelectedItem().toString(), "installments", account_name.getText());
