 ...
 * @author Dhananjaya
 */
public class PRCR_viewNedit_cash_advances_book1 extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       int PREFEREDROWS=20;
        ...
        if (search.getSelectedItem().toString().equals("View all")) {
            ...
            dbm.Inserting_To_The_Table(table, "prcr_cash_advance_book", "entry", 0, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_cash_advance_book", "date", 1, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_cash_advance_book", "code", 2, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_cash_advance_book", "type", 3, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_cash_advance_book", "amount", 4, 1, PREFEREDROWS);
            

        } else {
            try {
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_cash_advance_book", "entry", 0, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());

                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_cash_advance_book", "date", 1, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_cash_advance_book", "code", 2, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_cash_advance_book", "type", 3, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_cash_advance_book", "amount", 4, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
