 ...
 * @author Pramo
 */
public class PRCR_debit_pay extends javax.swing.JPanel {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(empCode_JC, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(9, 9, 9)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(division, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Code", "Name", "Type", "Amount", "division"
            }
        ));
...
//            division_jc.requestFocus();
    ...
    private void saveDataToAdvanceBook(Date date){
        ...
        int rowse = 0;
            ...
            try {
                dbCon.insert("INSERT INTO prcr_debit_pay(date,code,type,amount,division) VALUES('" +date + "','"+table.getValueAt(rowse, 0)+"','"+table.getValueAt(rowse, 2)+"','"+table.getValueAt(rowse, 3)+"','"+table.getValueAt(rowse, 4)+"')");
            } catch (SQLException ex) {
                Logger.getLogger(PRCR_Add_Employee.class.getName()).log(Level.SEVERE, null, ex);
                 JOptionPane.showMessageDialog(null, "Debit Pay book is not updated!\n", "Message", JOptionPane.INFORMATION_MESSAGE);
            }
            rowse++;
                }
...
public void Update_pr_workData(String tablename,Object code,String column,String new_amount){
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        PRCR_viewNedit_debit_pay jf = new PRCR_viewNedit_debit_pay();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            if(empCode_JC.getSelectedItem().toString().length()!=0){
                ...
                table.setValueAt("DEBIT PAY", rows, 2);
