 ...
 * @author Pramo
 */
public class Report_PRCR_cadvance extends javax.swing.JPanel {
        ...
        public void run() {
            ...
            if (!employee.isSelected()) {
                try {
                    ...
                    generate.create("PRCR_CADVANCE", "D:\\", param, location, "PRCR_cadvance.jrxml");
                    a.stop();
            ...
            if (employee.isSelected()) {
                ...
                if (empCode_JC.getSelectedItem() == null || empCode_JC.getSelectedItem().toString() == "") {
                    ...
                    try {
                        ...
                        generate.create("PRCR_CADVANCE", "D:\\", param, location, "PRCR_cadvance_sorted.jrxml");
                        a.stop();
                        jProgressBar1.setValue(100);
                    } catch (ParseException ex) {
                        Logger.getLogger(Report_GL_trans.class.getName()).log(Level.SEVERE, null, ex);
