 ...
 * @author Dhananjaya
 */
public class PRCR_cashadvance_edit_interface2 extends javax.swing.JFrame {

    /**
     * Creates new form PRCR_cashadvance_edit_interface2
     */
    ...
    public void fill_data(int entry) {//get the data from workentry for given entry number,will be called where the object is created
        ...
        cash=dbm.checknReturnData("prcr_cash_advance_book", "entry", entry, "amount");
        advance_amount.setText(cash);
    }

    
    public PRCR_cashadvance_edit_interface2() {
        initComponents();
    }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
     ...
     private void saveDataToAdvanceBook(Date date){
        DatabaseManager dbCon = DatabaseManager.getDbCon();
                   ...
                   dbm.updateDatabase("prcr_cash_advance_book", "entry", entry,"date",date);
                   dbm.updateDatabase("prcr_cash_advance_book", "entry", entry,"code",table.getValueAt(0, 0));
                   dbm.updateDatabase("prcr_cash_advance_book", "entry", entry,"type",table.getValueAt(0, 2));
                   dbm.updateDatabase("prcr_cash_advance_book", "entry", entry,"amount",table.getValueAt(0, 3));
...
public void Update_pr_workData(String tablename,Object code,String column,String new_amount){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRCR_cashadvance_edit_interface2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRCR_cashadvance_edit_interface2().setVisible(true);
            }
        });
    }
