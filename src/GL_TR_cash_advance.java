 ...
 * @author Pramo
 */
public class GL_TR_cash_advance extends javax.swing.JPanel {
    ...
    public void filldata() {
         String Name =dbm.checknReturnData("category", "category_id", Integer.parseInt(supplier_id.getSelectedItem().toString()), "categoty_name") ;
                           if(Name != null){
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
           ...
           // dbm.insert("CREATE TABLE gl_tr_cash_advance LIKE gl_cash_advance");
