                    ...
                    if (dr_count >= cr_count) {
                        ...
                        while (query1.next()) {
                            ...
                            if (count <= cr_count) {
                                ...
                                try {
                                    dbm.insert("INSERT INTO account_journal_report(tr_no,ref_no,date,pay_type,bank_id,branch_id,cheque_no,cheque_date,description,debit_account_id,debit_account_name,debit_description,debit_amount,credit_account_id,credit_account_name,credit_description,credit_amount) VALUES('" + query.getString("tr_no") + "','" + query.getString("ref_no") + "','" + query.getString("date") + "','" + query.getString("pay_type") + "','" + query.getInt("bank_id") + "','" + query.getInt("branch_id") + "','" + query.getString("cheque_no") + "','" + query.getString("cheque_date") + "','" + query.getString("description") + "','" + query1.getString("debit_account_id") + "','" + query1.getString("debit_account_name") + "','" + query1.getString("debit_description") + "','" + query1.getString("debit_amount") + "','" + query2.getString("credit_account_id") + "','" + query2.getString("credit_account_name") + "','" + query2.getString("credit_description") + "','" + query2.getString("credit_amount") + "')");
                                } catch (SQLException ex) {
                                ...
                                try {
                                    dbm.insert("INSERT INTO account_journal_report(tr_no,ref_no,date,pay_type,bank_id,branch_id,cheque_no,cheque_date,description,debit_account_id,debit_account_name,debit_description,debit_amount,credit_account_id,credit_account_name,credit_description,credit_amount) VALUES('" + query.getString("tr_no") + "','" + query.getString("ref_no") + "','" + query.getString("date") + "','" + query.getString("pay_type") + "','" + query.getInt("bank_id") + "','" + query.getInt("branch_id") + "','" + query.getString("cheque_no") + "','" + query.getString("cheque_date") + "','" + query.getString("description") + "','" + query1.getString("debit_account_id") + "','" + query1.getString("debit_account_name") + "','" + query1.getString("debit_description") + "','" + query1.getString("debit_amount") + "','" + 0 + "','" + null + "','" + null + "','" + 0 + "')");
                                } catch (SQLException ex) {
                                    MessageBox.showMessage(ex.getMessage(), "SQL Error", "error");
                                }
                        ...
                        while (query2.next()) {
                            ...
                            if (count <= dr_count) {
                                ...
                                try {
                                    dbm.insert("INSERT INTO account_journal_report(tr_no,ref_no,date,pay_type,bank_id,branch_id,cheque_no,cheque_date,description,debit_account_id,debit_account_name,debit_description,debit_amount,credit_account_id,credit_account_name,credit_description,credit_amount) VALUES('" + query.getString("tr_no") + "','" + query.getString("ref_no") + "','" + query.getString("date") + "','" + query.getString("pay_type") + "','" + query.getInt("bank_id") + "','" + query.getInt("branch_id") + "','" + query.getString("cheque_no") + "','" + query.getString("cheque_date") + "','" + query.getString("description") + "','" + 0 + "','" + null + "','" + null + "','" + 0 + "','" + query2.getString("credit_account_id") + "','" + query2.getString("credit_account_name") + "','" + query2.getString("credit_description") + "','" + query2.getString("credit_amount") + "')");
                                } catch (SQLException ex) {
                                    MessageBox.showMessage(ex.getMessage(), "SQL Error", "error");
                                }
