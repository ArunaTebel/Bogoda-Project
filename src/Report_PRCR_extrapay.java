 ...
 * @author Pramo
 */
public class Report_PRCR_extrapay extends javax.swing.JPanel {
        ...
        public void run() {
            ...
            if (!employee.isSelected()) {
                try {
                    ...
                    generate.create("PRCR_EXTRAPAY", "D:\\", param, location, "PRCR_extrapay.jrxml");
                    a.stop();
            ...
            if (employee.isSelected()) {
                ...
                if (empCode_JC.getSelectedItem() == null || empCode_JC.getSelectedItem().toString() == "") {
                    ...
                    try {
                        ...
                        param.put("to_date", Return_date2);
                        param.put("USER", user.get_current_user());
                        param.put("emp", empCode_JC.getSelectedItem().toString());

                        String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");

                        generate.create("PRCR_EXTRAPAY", "D:\\", param, location, "PRCR_extrapay_sorted.jrxml");
                        a.stop();
                        jProgressBar1.setValue(100);
                    } catch (ParseException ex) {
                        Logger.getLogger(Report_GL_trans.class.getName()).log(Level.SEVERE, null, ex);
   ...
   DatabaseManager dbm =  DatabaseManager.getDbCon();
    ...
    private void initComponents() {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(21, 21, 21)
                        .addComponent(empCode_JC, 0, 75, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(EmpName, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
       Thread c = new Thread(new report());
       c.start();
