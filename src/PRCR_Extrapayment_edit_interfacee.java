 ...
 * @author Dhananjaya
 */
public class PRCR_Extrapayment_edit_interfacee extends javax.swing.JFrame {
    ...
    int empCode;
    /**
     * Creates new form PRCR_Extrapayment_edit_interfacee
     */
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(87, 87, 87)
                        .addComponent(empName2, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE)
                        .addContainerGap())))
        );
        ...
        cashworkpanelLayout.setHorizontalGroup(
            ...
            .addGroup(cashworkpanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(cashworkpanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(amountT, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
                    .addComponent(daysT))
...
public void fill_data(int entry) {//get the data from workentry for given entry number,will be called where the object is created
        date1 = dbm.checknReturnData("prcr_extrapayment_book", "entry", entry, "date");
        dayfield.setText(date1.substring(8,10));
        monthfield.setText(datehandler.Return_month(Integer.parseInt(date1.substring(5,7))));
        yearfield.setText(date1.substring(0,4));
        
        empCode=Integer.parseInt(dbm.checknReturnData("prcr_extrapayment_book", "entry", entry, "code"));
        empCode_JC.setSelectedItem(empCode);
        
        if(dbm.checknReturnData("prcr_extrapayment_book", "entry",entry ,"type").toString().equals("CASHWORK")){
                cashworkC.setSelectedItem("CASHWORK");
                daysT.setText(dbm.checknReturnData("prcr_extrapayment_book", "entry",entry ,"days").toString());
                jLabel6.setText("Days");
        }
            else if(dbm.checknReturnData("prcr_extrapayment_book", "entry",entry ,"type").toString().equals("OVERKILOS")){
                cashworkC.setSelectedItem("OVERKILOS");
                daysT.setText(dbm.checknReturnData("prcr_extrapayment_book", "entry",entry ,"over_kilos").toString());
            jLabel6.setText("Over Kilos");
            }
          
        
        cash=dbm.checknReturnData("prcr_extrapayment_book", "entry", entry, "amount");
        amountT.setText(cash);
    }
 ...
 private void saveDataToExtraPaymentBook(Date date){
        ...
        dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"date",date);
                   dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"code",table.getValueAt(0, 0));
                   dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"type",table.getValueAt(0, 2));
                  if(cashworkC.getSelectedItem().toString().equals("OVERKILOS")){
                   dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"over_kilos",table.getValueAt(0, 5));
                  }else{
                      dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"days",table.getValueAt(0, 4));
                  } 
                  dbm.updateDatabase("prcr_extrapayment_book", "entry", entry,"amount",table.getValueAt(0, 3));
...
public void ClearTable(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRCR_Extrapayment_edit_interfacee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRCR_Extrapayment_edit_interfacee().setVisible(true);
            }
        });
    }
