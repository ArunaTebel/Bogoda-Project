...
public class BankInterface extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(Code1)
                    .addComponent(Name1, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            InsertData(Code1.getText(), Name1.getText());
    ...
    public void InsertData(String code, String name) {
        try {
           ...
           // System.out.println(amount + accountType);
            st.executeUpdate("INSERT INTO bank(Code,BankName) VALUES('" + code + "','" + name + "')");
