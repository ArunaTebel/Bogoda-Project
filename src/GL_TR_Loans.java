 ...
 * @author Pramo
 */
public class GL_TR_Loans extends javax.swing.JPanel {
...
//       }
    ...
    private void initComponents() {
        ...
        supplier_id.setModel(new javax.swing.DefaultComboBoxModel(dbm.getStringArray("category", "category_id")));
    ...
    private void BSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BSaveActionPerformed
            ...
            dbm.insert("INSERT INTO gl_tr_loans(sup_id,loan_id,type,amount,installments,rate,date,issue_date,monthly_amount) VALUES('" + supId + "','" + 0 + "','Current month','" + amount + "','" + installments + "','" + rate + "','" + loanDate + "','" + loanDate + "','" + monthlyPay[0] + "')");
            int transaction = dbm.readLastRow("gl_tr_loans", "tr_id");
            dbm.updateDatabase("gl_tr_loans", "tr_id", transaction, "loan_id", transaction);
            ...
            dbm.insert("INSERT INTO gl_tr_loans(sup_id,loan_id,type,amount,installments,rate,date,issue_date,monthly_amount) VALUES('" + supId + "','" + transaction + "','Previous','" + amount + "','" + installments + "','" + rate + "','" + date + "','" + loanDate + "','" + monthlyPay[i] + "')");
            }
    ...
    //    if (supplier_id.getSelectedIndex() != 0) {
            try {
                ...
                String category = null;
                   ...
                   /// String item = supplier_id.getSelectedItem().toString();
                try{
                   Name = dbm.checknReturnData("category", "category_id", supplier_id.getSelectedItem().toString(), "category_name") ;
 ...
 Date_Handler dt = new Date_Handler();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(reply==JOptionPane.YES_OPTION){
            dbm.CheckNDeleteFromDataBase("gl_tr_loans","loan_id",Integer.parseInt(edit.getText()));
            supplier_id.setSelectedIndex(0);
        ...
        if(evt.getKeyCode() == KeyEvent.VK_ENTER){
           try{
            try {
                ...
                supplier_id.setSelectedItem(dbm.checknReturnData("gl_tr_loans","tr_id",tr_no,"sup_id"));
                 amountField.setText(dbm.checknReturnData("gl_tr_loans", "tr_id", tr_no, "amount"));
               installmentsField.setText(dbm.checknReturnData("gl_tr_loans", "tr_id", tr_no, "installments"));
                rateField.setText(dbm.checknReturnData("gl_tr_loans", "tr_id", tr_no, "rate"));

                String date= dbm.checknReturnData("gl_tr_loans","tr_id",tr_no,"issue_date");
