 ...
 * @author Dhananjaya
 */
public class PRCR_viewNedit_extra_payment_book extends javax.swing.JFrame {
    ...
    public PRCR_viewNedit_extra_payment_book() {
        initComponents();
        try{
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Entry", "Date", "Employee Code", "Advance Type", "Over Kilos","Days","Amount"
            }
        ));
  ...
  public boolean Inserting_To_The_Table_Filtered_Between_Two(javax.swing.JTable table, String table_name, String column_name, int table_column_num, int bottom, int top, String column_filtering, String element1, String element2) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (search.getSelectedItem().toString().equals("View all")) {
            ...
            dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "entry", 0, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "date", 1, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "code", 2, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "type", 3, 1, PREFEREDROWS);
             dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "over_kilos", 4, 1, PREFEREDROWS);
              dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "days", 5, 1, PREFEREDROWS);
            dbm.Inserting_To_The_Table(table, "prcr_extrapayment_book", "amount", 6, 1, PREFEREDROWS);
            

        } else {
            try {
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "entry", 0, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());

                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "date", 1, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "code", 2, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "type", 3, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "over_kilos", 4, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "days", 5, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
                Inserting_To_The_Table_Filtered_Between_Two(table, "prcr_extrapayment_book", "amount", 6, 1, PREFEREDROWS, "date", datechooser.Return_date(yearfield1, monthfield1, dayfield1).toString(), datechooser.Return_date(yearfield2, monthfield2, dayfield2).toString());
    ...
    int row[] = table.getSelectedRows();
        ...
        PRCR_Extrapayment_edit_interfacee cadintf=new PRCR_Extrapayment_edit_interfacee();
        System.err.println("dsadgwfrg");
...
int rowd = table.getSelectedRows()[0];
        ...
        dbm.CheckNDeleteFromDataBase("prcr_extrapayment_book","entry", entryd);
