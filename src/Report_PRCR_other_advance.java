 ...
 * @author Pramo
 */
public class Report_PRCR_other_advance extends javax.swing.JPanel {
    ...
    public class report implements Runnable {
        ...
        public void run() {
            ...
            if(!employee.isSelected() && !advanceType.isSelected()){
                try {
                    ...
                    generate.create("PRCR_OTHER_ADVANCE", "D:\\", param, location, "PRCR_other_advance.jrxml");
                    a.stop();
           ...
           else if (!employee.isSelected() && advanceType.isSelected() ) {
                try {
                    HashMap param = new HashMap();
                    a.start();
                    Date Return_date1 = datechooser.Return_date(yearfield, monthfield, dayfield);
                    ...
                    param.put("USER", user.get_current_user());
                    param.put("a", "type");
                    param.put("b", advance_type.getSelectedItem().toString());

                    String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");

                    generate.create("PRCR_CADVANCE", "D:\\", param, location, "PRCR_other_advance_sorted.jrxml");
                    a.stop();
                    jProgressBar1.setValue(100);
                } catch (ParseException ex) {
                    Logger.getLogger(Report_GL_trans.class.getName()).log(Level.SEVERE, null, ex);
                ...
                if (empCode_JC.getSelectedItem() == null || empCode_JC.getSelectedItem().toString() == "") {
                    JOptionPane.showMessageDialog(datechooser, "Select Employee Code");
                } else {
                    try {
                        HashMap param = new HashMap();
                        a.start();
                        ...
                        generate.create("PRCR_OTHER_ADVANCE", "D:\\", param, location, "PRCR_other_advance_sorted.jrxml");
                        a.stop();
                        jProgressBar1.setValue(100);
                    } catch (ParseException ex) {
                        Logger.getLogger(Report_GL_trans.class.getName()).log(Level.SEVERE, null, ex);
                ...
                if (empCode_JC.getSelectedItem() == null || empCode_JC.getSelectedItem().toString() == "") {
                    ...
                    try {
                        ...
                        param.put("b",empCode_JC.getSelectedItem().toString());
                        param.put("c", "type");
                    param.put("d", advance_type.getSelectedItem().toString());

                        String location = dbm.checknReturnStringData("file_locations", "description", "Reports", "location");

                        generate.create("PRCR_OTHER_ADVANCE", "D:\\", param, location, "PRCR_other_advance_sorted2.jrxml");
                        a.stop();
                        jProgressBar1.setValue(100);
                    } catch (ParseException ex) {
                        Logger.getLogger(Report_GL_trans.class.getName()).log(Level.SEVERE, null, ex);
     ...
     *
     */
    public Report_PRCR_other_advance() {
        initComponents();
    ...
    private void initComponents() {
        ...
        advanceType = new javax.swing.JCheckBox();
        ...
        advanceType.setText("Advance Type");
        advanceType.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                advanceTypeItemStateChanged(evt);
            }
        });
        advanceType.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                advanceTypeActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(21, 21, 21)
                        .addComponent(empCode_JC, 0, 0, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel3)
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(advanceType)
        ...
        jLabel4.setText("Other Advances");
    ...
    private void advanceTypeItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_advanceTypeItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_advanceTypeItemStateChanged

    private void advanceTypeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_advanceTypeActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_advanceTypeActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel EmpName;
    private javax.swing.JCheckBox advanceType;
