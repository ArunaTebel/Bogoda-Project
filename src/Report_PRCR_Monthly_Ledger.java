 ...
 * @author Pramo
 */
public class Report_PRCR_Monthly_Ledger extends javax.swing.JPanel {
...
//         param.put("Month", datehandler.return_month_as_num(monthfield.getText()));
            ...
            jProgressBar1.setValue(100);
            try {
                generate.savename(dateNow, "PRCR_Checkroll_Monthly_Ledger_", yearfield.getText() + datehandler.return_month_as_num(monthfield.getText()));
            } catch (SQLException ex) {
                Logger.getLogger(Report_GL_daily_transactions.class.getName()).log(Level.SEVERE, null, ex);
            }
     ...
     *
     */
    public Report_PRCR_Monthly_Ledger() {
        initComponents();
