...
private String month;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add margin dates for month");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PRCR_add_margin_dates.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PRCR_add_margin_dates().setVisible(true);
            }
        });
    }
