 ...
 * @author Pramo
 */
public class Report_PRCR_ETF_6Month extends javax.swing.JPanel {
...
//    }
    ...
    public class report_old implements Runnable {
        ...
        public void run() {
            ...
            String dateNow = generate.create("PRCR_Checkroll_6Monthl_ETF_", "D:\\", param, location, "PRCR_ETF_firsthalf.jrxml");
               }else if(last6.isSelected()){
               String dateNow = generate.create("PRCR_Checkroll_6Monthl_ETF_", "D:\\", param, location, "PRCR_ETF_secondhalf.jrxml");
