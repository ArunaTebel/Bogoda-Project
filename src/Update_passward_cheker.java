 ...
 * @author Pramo
 */
public class Update_passward_cheker extends javax.swing.JFrame {

    /**
     * Creates new form Update_passward_cheker
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter The Adminstrator Username and Password");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       DatabaseManager dbm = new DatabaseManager();
        ...
        if(jPasswordField1.getText().equals(user) && type.equals("Administrator")){
        jLabel2.setText("");
        Task_manager addbrnch = new Task_manager();
        addbrnch.Final_focus();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_passward_cheker.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Update_passward_cheker().setVisible(true);
            }
        });
    }
