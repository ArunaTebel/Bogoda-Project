 ...
 * @author Pramo
 */
public class GL_TR_Other_Advances extends javax.swing.JPanel {
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGap(52, 52, 52))
                                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                                .addComponent(supplier_id, javax.swing.GroupLayout.PREFERRED_SIZE, 132, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)))
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//                }
     ...
     String Name =   dbm.checknReturnData("category", "category_id", supplier_id.getSelectedItem().toString(), "category_name");
                      if(Name != null){
         try {
    ...
    private void save1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save1ActionPerformed
            ...
            cadvance.set_cat_id(supplier_id.getSelectedItem().toString());
    ...
    private void qtyKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_qtyKeyReleased
       String result, result2;
        try {
                    result = dbm.filterReturn3StringData("gl_tr_other_advances", "id", supplier_id.getSelectedItem() + "", "Date", datechooser.Return_date(yearfield, monthfield, dayfield) + "","item_name",CodeName.getText(), "tr_no");
         ...
         if(evt.getKeyCode() == KeyEvent.VK_ENTER){
             ...
             try {
                ...
                if(!edit.getText().equals("")){ tr_no = Integer.parseInt(edit.getText());            }
                 ...
                 supplier_id.setSelectedItem(dbm.checknReturnData("gl_tr_other_advances","tr_no",tr_no,"id"));
                 order_no.setText(dbm.checknReturnData("gl_tr_other_advances","tr_no",tr_no,"order_num"));
                 Discription_code.setSelectedItem(dbm.checknReturnData("rate_details","Name",dbm.checknReturnData("gl_tr_other_advances","tr_no",tr_no,"item_name"),"Code_name"));
                 qty.setText(dbm.checknReturnData("gl_tr_other_advances","tr_no",tr_no,"item_quantity"));
                 amount.setText(""+(Double.parseDouble(qty.getText())*Double.parseDouble(Rate.getText())));
                 
                 String date= dbm.checknReturnData("gl_tr_other_advances","tr_no",tr_no,"Date");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(reply==JOptionPane.YES_OPTION){
            dbm.CheckNDeleteFromDataBase("gl_tr_other_advances","tr_no",Integer.parseInt(edit.getText()));
